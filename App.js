    ...
    return (
      <View style={{ padding: 10 }}>
        ...
        <Salada 
          ...
          receita="1/4 de xícara de chá de iogurte natural, 
        ...
        <Salada
          ...
          titulo="Salada César"
          receita="1 pé de alface romana, 1
          /2 xícara de queijo parmesão ralado, 
  ...
  render() {
    return (
      <View style={{ marginBottom: 20, padding: 10, }}>
        ...
        <Text style={{ marginVertical: 5 }}>{this.props.receita}</Text>
        {this.props.imagem && (
          <Image
